...
import 'package:firebaseapis_beta/firestore/v1beta1.dart' as api;
...
core.List<api.GoogleFirestoreAdminV1beta1IndexField> buildUnnamed20() => [
      buildGoogleFirestoreAdminV1beta1IndexField(),
      buildGoogleFirestoreAdminV1beta1IndexField(),
    ];

void checkUnnamed20(core.List<api.GoogleFirestoreAdminV1beta1IndexField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleFirestoreAdminV1beta1Index> buildUnnamed21() => [
      buildGoogleFirestoreAdminV1beta1Index(),
      buildGoogleFirestoreAdminV1beta1Index(),
    ];

void checkUnnamed21(core.List<api.GoogleFirestoreAdminV1beta1Index> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.Value> buildUnnamed27() => {
      'x': buildValue(),
      'y': buildValue(),
    };

void checkUnnamed27(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o['x']!);
  checkValue(o['y']!);
}
...
core.List<api.Cursor> buildUnnamed28() => [
      buildCursor(),
      buildCursor(),
    ];

void checkUnnamed28(core.List<api.Cursor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCursor(o[0]);
  checkCursor(o[1]);
}
...
core.List<api.FieldReference> buildUnnamed29() => [
      buildFieldReference(),
      buildFieldReference(),
    ];

void checkUnnamed29(core.List<api.FieldReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CollectionSelector> buildUnnamed32() => [
      buildCollectionSelector(),
      buildCollectionSelector(),
    ];

void checkUnnamed32(core.List<api.CollectionSelector> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCollectionSelector(o[0]);
  checkCollectionSelector(o[1]);
}

core.List<api.Order> buildUnnamed33() => [
      buildOrder(),
      buildOrder(),
    ];

void checkUnnamed33(core.List<api.Order> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrder(o[0]);
  checkOrder(o[1]);
}
...
api.StructuredQuery buildStructuredQuery() {
  ...
  if (buildCounterStructuredQuery < 3) {
    o.endAt = buildCursor();
    o.from = buildUnnamed32();
    o.limit = 42;
    o.offset = 42;
    o.orderBy = buildUnnamed33();
...
void main() {
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1beta1ExportDocumentsRequest',
    ...
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1beta1ExportDocumentsRequest.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1beta1ImportDocumentsRequest',
    ...
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1beta1ImportDocumentsRequest.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
  ...
  unittest.group('resource-ProjectsDatabasesResource', () {
    unittest.test('method--exportDocuments', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
            api.GoogleFirestoreAdminV1beta1ExportDocumentsRequest.fromJson(
    ...
    unittest.test('method--importDocuments', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
            api.GoogleFirestoreAdminV1beta1ImportDocumentsRequest.fromJson(
                json as core.Map<core.String, core.dynamic>);
  ...
  unittest.group('resource-ProjectsDatabasesIndexesResource', () {
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp =
            convert.json.encode(buildGoogleFirestoreAdminV1beta1Index());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
