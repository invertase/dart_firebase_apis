...
core.int buildCounterDownloadModelResponse = 0;
api.DownloadModelResponse buildDownloadModelResponse() {
  final o = api.DownloadModelResponse();
  buildCounterDownloadModelResponse++;
  if (buildCounterDownloadModelResponse < 3) {
    o.downloadUri = 'foo';
    o.expireTime = 'foo';
    o.modelFormat = 'foo';
    o.sizeBytes = 'foo';
...
void checkDownloadModelResponse(api.DownloadModelResponse o) {
  buildCounterDownloadModelResponse++;
  if (buildCounterDownloadModelResponse < 3) {
    unittest.expect(
      o.downloadUri!,
...
core.List<api.Model> buildUnnamed0() => [
      buildModel(),
      buildModel(),
    ];

void checkUnnamed0(core.List<api.Model> o) {
...
api.Model buildModel() {
  ...
  if (buildCounterModel < 3) {
    o.activeOperations = buildUnnamed1();
    o.createTime = 'foo';
    o.displayName = 'foo';
    o.etag = 'foo';
    o.modelHash = 'foo';
...
void checkModel(api.Model o) {
  buildCounterModel++;
  if (buildCounterModel < 3) {
    checkUnnamed1(o.activeOperations!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
...
void main() {
  unittest.group('obj-schema-DownloadModelResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDownloadModelResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DownloadModelResponse.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
      checkDownloadModelResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ModelState', () {
    unittest.test('to-json--from-json', () async {
      final o = buildModelState();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.ModelState.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkModelState(od);
    });
  });
  ...
  unittest.group('obj-schema-TfLiteModel', () {
    unittest.test('to-json--from-json', () async {
      final o = buildTfLiteModel();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TfLiteModel.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
      checkTfLiteModel(od);
    });
  });
  ...
  unittest.group('resource-ProjectsModelsResource', () {
    unittest.test('method--create', () async {
      ...
      final res = api.FirebaseMLApi(mock).projects.models;
    ...
    unittest.test('method--download', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp = convert.json.encode(buildDownloadModelResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response = await res.download(arg_name, $fields: arg_$fields);
      checkDownloadModelResponse(response as api.DownloadModelResponse);
    });
  ...
  unittest.group('resource-ProjectsOperationsResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.FirebaseMLApi(mock).projects.operations;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
